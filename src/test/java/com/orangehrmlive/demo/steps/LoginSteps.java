...
public class LoginSteps {
    ...
    public void iEnterUsername(String username) {
        new LoginPage().sendDataToUserNameField(username);
    }
    ...
    public void iShouldGetErrorMessageDependsOnUsernameAndPassword(String expectedError, String username, String password) {
